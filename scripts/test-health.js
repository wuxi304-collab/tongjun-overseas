...
async function run(){
  ...
  assert.equal(res.payload.site_release,'V34.152 R15.12');
  ...
  assert.equal(res.headers['X-Tongjun-Release'],'V34.152 R15.12');
  ...
  console.log('PASS: R15.12 production health requires HTTPS RFQ routing + HMAC secret, with release identity, HEAD and method gates validated.');
}
