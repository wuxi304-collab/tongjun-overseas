...
async function run(){
  ...
  assert.equal(res.payload.site_release,'V34.152 R15.8');
  ...
  assert.equal(res.headers['X-Tongjun-Release'],'V34.152 R15.8');
  ...
  console.log('PASS: R15.8 production health identity, readiness, HEAD and method gates validated.');
}
