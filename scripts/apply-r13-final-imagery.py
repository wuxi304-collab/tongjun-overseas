...
LOGO = f'/assets/images/logo-r13.webp?v={VERSION}'
HERO = f'/assets/images/hero-port-r13.webp?v={VERSION}'
QUALITY = f'/assets/images/quality-lab-r13.webp?v={VERSION}'
ENGINEERING = f'/assets/images/engineering-team-r13.webp?v={VERSION}'
TECHNICAL = f'/assets/images/technical-lab-r13.webp?v={VERSION}'

LOGO_HTML = (
    f'<img class="tj-logo-img tj-logo-r13" src="{LOGO}" alt="Tongjun Metal Tech · Since 2010" '
    'width="1200" height="400" decoding="async" fetchpriority="high" />'
)
FOOTER_LOGO = (
    f'<img class="tj-footer-logo tj-logo-r13" src="{LOGO}" alt="Tongjun Metal Tech · Since 2010" '
    'width="1200" height="400" decoding="async" loading="lazy" />'
)
HERO_HTML = (
    f'<img class="hero-bg-r6 hero-bg-r13" src="{HERO}" '
    'alt="Tongjun Metal Tech special-metal coils prepared for international delivery at an industrial port" '
    'width="1500" height="844" decoding="async" fetchpriority="high" />'
)
...
def replace_visual(s: str, page_name: str) -> str:
    ...
    visual = (
        ...
        f'<img alt="{alt}" decoding="async" loading="eager" fetchpriority="high" src="{img}" width="1300" height="731"/>'
...
for p in ROOT.glob('*.html'):
    ...
    # Final brand date language: no EST. 2026 survives R13.
    s = s.replace('EST. 2026', 'SINCE 2010')
    s = s.replace('Est. 2026', 'Since 2010')
    s = s.replace('est. 2026', 'since 2010')

    # Replace every header/footer brand fallback with the approved Columbus logo.
    ...
    # Replace older people imagery globally with approved branded-workwear R13 assets.
...
print(f'PASS: R13 approved logo, SINCE 2010 brand date, hero and branded-workwear imagery applied to {len(changed)} HTML files.')
