...
for p in ROOT.glob('*.html'):
    ...
    if p.name == 'materials.html':
        ...
        for src in ['/assets/images/resources-metal.webp','/assets/images/standards-rfq.webp','/assets/images/quality-inspection.webp','/assets/images/quality-lab-v2.webp','/assets/images/technical-lab-r11.webp?v=20260914-r11']:
            s = s.replace(src, '/assets/images/quality-r8.webp?v=20260914-r8')
        if 'technical-visual' not in s:
            visual = '<section class="visual-band technical-visual"><div class="wrap"><div class="visual-frame"><img alt="Metallurgical inspection and controlled technical data review" decoding="async" loading="eager" src="/assets/images/quality-r8.webp?v=20260914-r8" width="1200" height="510"/><span class="visual-label">Material data · verification · controlled reference</span></div></div></section>'
            m = re.search(r'(<nav aria-label="Section navigation".*?</nav>)', s, re.S)
            if m: s = s[:m.end()] + visual + s[m.end():]
    elif p.name == 'about.html':
        for src in ['/assets/images/about-engineering.webp','/assets/images/resources-metal.webp','/assets/images/engineering-discussion-v2.webp','/assets/images/engineering-review-r11.webp?v=20260914-r11']:
            s = s.replace(src, '/assets/images/engineering-discussion-v2.webp?v=20260914-r11')
        s = s.replace('>Engineering-led sourcing<', '>Requirement review · source role · evidence boundary<')
    elif p.name == 'rfq.html':
        for src in ['/assets/images/standards-rfq.webp','/assets/images/about-engineering.webp','/assets/images/engineering-review-v2.webp','/assets/images/engineering-review-r11.webp?v=20260914-r11']:
            s = s.replace(src, '/assets/images/engineering-review-v2.webp?v=20260914-r11')
        if 'rfq-visual' not in s:
            visual = '<section class="visual-band rfq-visual"><div class="wrap"><div class="visual-frame"><img alt="Engineering and sourcing team reviewing a controlled special-metals requirement" decoding="async" loading="eager" src="/assets/images/engineering-review-v2.webp?v=20260914-r11" width="1200" height="510"/><span class="visual-label">Requirement review · route control · buyer release</span></div></div></section>'
    ...
    s = s.replace('</head>', '<link rel="stylesheet" href="/assets/brand-v34.152-r11.css?v=20260914-r11b"><script defer src="/assets/brand-v34.152.js?v=20260914-r11b"></script></head>')
